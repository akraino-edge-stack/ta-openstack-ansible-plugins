...
URL:            https://github.com/openstack/openstack-ansible-plugins
BuildArch:      noarch
Summary:        openstack-ansible-plugins
...
rsync -av --exclude LICENSE --exclude rpmbuild.spec --exclude .git/ --exclude .gitreview . %{buildroot}/etc/ansible/roles/plugins/
